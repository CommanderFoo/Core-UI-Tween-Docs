--[[
	...
	I have included a template that you can drag and drop into yur hierarchy so you can test out some of the animations.
	...
	The example comes with 12 you can try.  It's best to try them in order because some animations rely on the state
